...
// Optional: Toggle Module Visibility
function toggleModule(button) {
    const moduleBody = button.closest('.module').querySelector('.module-body');
    const moduleDetails = button.closest('.module').querySelector('.module-details');
